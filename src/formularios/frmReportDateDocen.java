 ...
 * @author Dan Arevalo
 */
public class frmReportDateDocen extends javax.swing.JFrame {
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        conn.startReport("Docentes", jasper);
        cmbGenerar.setModel(modeloGenerar);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReportDateDocen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> {
            new frmReportDateDocen().setVisible(true);
        });
    }
